  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-club': 'linear-gradient(180deg, hsl(var(--primary-dark)) 0%, hsl(var(--primary)) 100%)',
        'gradient-hero': 'linear-gradient(135deg, hsl(222 85% 18% / 0.95) 0%, hsl(222 85% 29% / 0.7) 100%)',
      },
    },
  },
